...
// WebcamFeed provides a simple live preview and a `capture()` method via ref that
// returns a data URL for the current frame. This keeps the UI self-contained and
// avoids pulling in external libs for the capture itself.
  ...
  useEffect(() => {
    ...
    const start = async () => {
      try {
        ...
        // ignore: caller will handle capture errors
